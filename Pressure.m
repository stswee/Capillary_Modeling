...
[W, t] = meshgrid(Wspan, Tspan);

%% Solving for Pressure
P = B - alpha * W - (B - Ptime(t)).*beta(W, delta); 
...
% Determine where surface intersects Pc
Pdiff = P - Pc;
C = contours(W, t, Pdiff, [0 0]);
WL = C(1, 2:end);
tL = C(2, 2:end);
PL = interp2(W, t, P, WL, tL);
line(WL, tL, PL, 'Color', 'k', 'LineWidth', 3);
...
zlabel('$P (mmHg)$', 'Interpreter', 'latex')
view(45, 30);
axis tight
shading interp
